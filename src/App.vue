<template>
  <div>
    ...
    <main>
      ...
      <div class="contenedor">
        ...
        <div class="cont-acciones">
          ...
          <div class="cuerpo-acciones">
            <button class="btn-acciones" @click="aparece()"><i class="fa fa-list-ul"></i>LISTAR BOLETAS</button>
      ...
      <div v-if="table" class="caja">
        <h1 class="head">Registro de Boletas vendidas <span @click="desaparece()" style="cursor: pointer;">❎</span></h1>
        <table id="tab">
          <thead>
            <tr>
              <th>Nombre</th>
...
function download() {
      ...
      let headers = ['Nombre','Direccion','Telefono','Fecha','Estado','Numero de Boleta'];
      autoTable(doc, {
        head: [headers],
        body: bodyData,
      });
